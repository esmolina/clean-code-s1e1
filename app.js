...
var incompleteTaskHolder=document.getElementById("incompletedTasks");//incompleted-tasks
...
var createNewTaskElement=function(taskString){
  ...
  editButton.className="list-form__button_edit";

  deleteButton.className="list-form__button_delete";
